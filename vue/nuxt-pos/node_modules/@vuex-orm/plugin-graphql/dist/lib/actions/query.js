            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        schema = _c.sent();
                        // Filter
                        filter = filter ? transformer_1.default.transformOutgoingData(model, filter, true) : {};
                        multiple = schema_1.default.returnsConnection(schema.getQuery(name));
                        query = query_builder_1.default.buildQuery("query", model, name, filter, multiple, false);
