            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, context.apollo.simpleMutation(utils_1.graphQlDocumentToString(parsedQuery), variables)];
                    case 1:
                        result = _c.sent();
                        // remove the symbols
                        return [2 /*return*/, utils_1.clone(result.data)];
                    case 2: 
...
exports.default = SimpleMutation;
