            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        parsedQuery = utils_1.parseQuery(query);
                        ...
                        return [4 /*yield*/, context.apollo.simpleQuery(utils_1.graphQlDocumentToString(parsedQuery), variables, bypassCache)];
                    case 1:
                        result = _c.sent();
                        // remove the symbols
                        return [2 /*return*/, utils_1.removeSymbols(utils_1.clone(result.data))];
                    case 2: 
