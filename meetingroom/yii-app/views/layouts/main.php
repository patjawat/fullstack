...
<body class="layout-top-nav"
    style="font-family: 'Kanit', sans-serif;background-image: linear-gradient(-90deg, #5f72bd 0%, #9b23ea 100%);">
    <?php $this->beginBody() ?>
    <?php
    Modal::begin([
        'id' => 'main-modal',
    ...
    ?>
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white shadow-sm p-3 mb-5 bg-white rounded">
            <div class="container">
                <a href="../../index3.html" class="navbar-brand">
                    <img src="/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                        style="opacity: .8">
                    <span class="brand-text font-weight-light">Meeting V1</span>
                </a>
